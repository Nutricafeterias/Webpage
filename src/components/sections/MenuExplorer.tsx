...
const ITEMS: MenuItem[] = [
  ...
  { name: 'Chilaquiles verdes con pollo', cat: 'Desayuno', kcal: 430, protein: 24, tags: ['Alto en proteína'], emoji: '🍲', desc: 'Totopos horneados, salsa verde de la casa, pollo deshebrado y crema ligera.' },
  { name: 'Hot cakes de avena con fruta', cat: 'Desayuno', kcal: 350, protein: 12, tags: ['Vegetariano'], emoji: '🥞', desc: 'Hot cakes de avena y plátano con fruta fresca — sin harinas refinadas.' },
  { name: 'Quesadillas de queso en tortilla de maíz', cat: 'Comida', kcal: 330, protein: 14, tags: ['Vegetariano', 'Sin gluten'], emoji: '🫓', desc: 'El clásico que nunca falla: tortilla de maíz hecha al momento y queso Oaxaca.' },
  { name: 'Torta de jamón con aguacate', cat: 'Comida', kcal: 410, protein: 18, tags: [], emoji: '🥪', desc: 'Bolillo, jamón de pierna, aguacate, jitomate y lechuga — la torta de siempre, bien hecha.' },
  { name: 'Sándwich de pollo con verduras', cat: 'Comida', kcal: 380, protein: 24, tags: ['Alto en proteína'], emoji: '🥙', desc: 'Pan integral, pechuga de pollo, lechuga, jitomate y aderezo de yogurt.' },
  { name: 'Sincronizada de jamón y queso', cat: 'Snacks', kcal: 340, protein: 16, tags: [], emoji: '🧀', desc: 'Tortilla de harina, jamón de pierna y queso — para el antojo del receso.' },
  { name: 'Esquites naturales', cat: 'Snacks', kcal: 140, protein: 5, tags: ['Vegetariano', 'Sin gluten'], emoji: '🌽', desc: 'Elote amarillo con limón y queso fresco — sin mayonesa industrial.' },
